...
<div class="text-center container-fluid">
    ...
    <h1 class="h1 mb-3 fw-normal">Produkt erstellen</h1>
            ...
            <form id="productForm" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="productDescription" rows="3" name="productDescription"
                              placeholder="Hier kommt die Beschreibung des Grillers hin."></textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="gas" id="categoryGas"
                                   name="productCategoriesGas">
                            <label class="form-check-label" for="categoryGas">Gas Griller</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="charcoal" id="categoryCharcoal"
                                   name="productCategoriesCharcoal">
