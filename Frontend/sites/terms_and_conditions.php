...
<div class="text-center container-fluid">
  <div class="row">
    ...
    <div class="col-10">
      ...
      <p>
        § 1 BEDINGUNGEN FÜR DEN ONLINESHOP<br>
        § 2 ALLGEMEINE BEDINGUNGEN<br>
        § 3 GENAUIGKEIT, VOLLSTÄNDIGKEIT UND RECHTZEITIGKEIT DER INFORMATIONEN<br>
        § 4 ÄNDERUNGEN AN DER LEISTUNG UND DEN PREISEN<br>
        § 5 PRODUKTE ODER SERVICELEISTUNGEN (falls zutreffend)&nbsp;<br>
        § 6 RICHTIGKEIT DER RECHNUNGS- UND KONTOINFORMATIONEN&nbsp;<br>
        § 7 ZUSÄTZLICHE TOOLS<br>
        § 8 DRITTANBIETER-LINKS<br>
        § 9 BENUTZERKOMMENTARE, FEEDBACK UND ANDERE EINSENDUNGEN<br>
        § 10 PERSONENBEZOGENE DATEN<br>
        § 11 FEHLER, UNGENAUIGKEITEN UND AUSLASSUNGEN<br>
        § 12 VERBOTENE ANWENDUNGEN<br>
        § 13 HAFTUNGSAUSSCHLUSS; HAFTUNGSBESCHRÄNKUNG<br>
        § 14 ENTSCHÄDIGUNG<br>
        § 15 KÜNDIGUNG<br>
        § 16 GESAMTE VEREINBARUNG<br>
        § 17 Erfüllungsort, Gerichtsstand und Rechtswahl<br>
        § 18 GELTENDES RECHT <br>
        § 19 ÄNDERUNGEN DER ALLGEMEINEN GESCHÄFTSBEDINGUNGEN <br>
        § 20 KONTAKTDATEN
      </p> <br>

      <div class="ce-regular-text-element-content">
        <p>Diese Website wird von Dream Griller GmbH betrieben. Überall auf der Webseite beziehen sich die Begriffe "wir", "uns" und "unsere/e" auf Dream Griller GmbH. Dream Griller GmbH bietet diese Website, einschließlich aller Informationen, Tools und Dienste, die auf dieser Website verfügbar sind, Ihnen, dem Benutzer, unter der Bedingung an, dass Sie alle hier angegebenen Bedingungen, Konditionen, Richtlinien und Hinweise akzeptieren.
        <br>
      ...
      <div class="ce-regular-text-element-content">
        <h3>§ 2 - ALLGEMEINE BEDINGUNGEN</h3>
        <p>Wir behalten uns das Recht vor, einer Person die Serviceleistung jederzeit aus beliebigem Grund zu verweigern.
      ...
      <div class="ce-regular-text-element-content">
        <h3>§ 3 - GENAUIGKEIT, VOLLSTÄNDIGKEIT UND RECHTZEITIGKEIT DER INFORMATIONEN</h3>
        <p>Wir sind nicht verantwortlich, wenn die auf dieser Seite zur Verfügung gestellten Informationen nicht genau, vollständig oder aktuell sind. Das Material auf dieser Website dient nur der allgemeinen Information und sollte nicht als alleinige Grundlage für Entscheidungen herangezogen werden, ohne primäre, genauere, vollständigere oder aktuellere Informationsquellen zu prüfen. Jegliches Vertrauen in das Material auf dieser Website geschieht auf eigene Verantwortung.
      ...
      <div class="ce-regular-text-element-content">
        <h3>§ 4 - ÄNDERUNGEN AN DER LEISTUNG UND DEN PREISEN</h3>
        <p>Die Preise für unsere Produkte können ohne vorherige Ankündigung geändert werden.
      ...
      <div class="ce-regular-text-element-content">
        <h3>§ 5 - PRODUKTE ODER SERVICELEISTUNGEN (falls zutreffend)</h3>
        <p>Gewisse Produkte oder Serviceleistungen sind möglicherweise nur online über die Website erhältlich. Diese Produkte oder Serviceleistungen sind unter Umständen nur in begrenzten Mengen vorhanden und unterliegen nur der Rückgabe oder dem Umtausch gemäß unseren Rückgaberichtlinien.
      ...
      <div class="ce-regular-text-element-content">
        ...
        Für weitere Details lesen Sie bitte unsere Rückgaberichtlinien.</p>
      </div>

      <div class="ce-regular-text-element-content">
        <h3>§ 7 - ZUSÄTZLICHE TOOLS</h3>
        <p>Wir bieten Ihnen möglicherweise Zugriff auf Tools von Drittanbietern, die wir weder überwachen noch kontrollieren oder beeinflussen können.
      ...
      <div class="ce-regular-text-element-content">
        <h3>§ 8 - DRITTANBIETER-LINKS</h3>
        <p>Gewisse Inhalte, Produkte und Serviceleistungen, die über unseren Service erhältlich sind, können Materialien von Drittanbietern umfassen.
      ...
      <div class="ce-regular-text-element-content">
        <h3>§ 9 - BENUTZERKOMMENTARE, FEEDBACK UND ANDERE EINSENDUNGEN</h3>
      ...
      <div class="ce-regular-text-element-content">
        <h3>§ 10 - PERSONENBEZOGENE DATEN</h3>
        <p>Die Übermittlung von personenbezogenen Daten über den Shop unterliegt unserer Datenschutzerklärung. Lesen Sie dafür unsere Datenschutzerklärung.
        </p>
      </div>
      ...
      <div class="ce-regular-text-element-content">
        <h3>§ 12 - VERBOTENE ANWENDUNGEN</h3>
      ...
      <div class="ce-regular-text-element-content">
        <h3>§ 13 - HAFTUNGSAUSSCHLUSS; HAFTUNGSBESCHRÄNKUNG</h3>
        <p>Wir garantieren nicht, dass die Ergebnisse, die durch die Nutzung der Serviceleistung erzielt werden können, genau oder zuverlässig sind.
      ...
      <div class="ce-regular-text-element-content">
        <h3>§ 17 - GESAMTE VEREINBARUNG</h3>
        <p>Das Versäumnis unsererseits, ein Recht oder eine Bestimmung dieser Allgemeinen Geschäftsbedingungen auszuüben oder durchzusetzen, stellt keinen Verzicht auf dieses Recht oder diese Bestimmung dar.
      ...
      <div class="ce-regular-text-element-content">
        <h3>§ 18 - GELTENDES RECHT</h3>
        <p>Diese Allgemeinen Geschäftsbedingungen und alle separaten Vereinbarungen, in deren Rahmen wir Ihnen Serviceleistungen zur Verfügung stellen, unterliegen den Gesetzen von Praterstraße 33 , Wien, Wien, 1020, Österreich und sind nach diesen auszulegen.
        </p>
      </div>

      <div class="ce-regular-text-element-content">
        <h3>§ 19 – ÄNDERUNGEN DER ALLGEMEINEN GESCHÄFTSBEDINGUNGEN</h3>
      ...
      <div class="ce-regular-text-element-content">
        ...
        <p>Fragen zu den Allgemeinen Geschäftsbedingungen sind unter <a href="mailto:office@dream-griller.at">office@dream-griller.at</a> an uns zu richten.
        </p>
      </div>
